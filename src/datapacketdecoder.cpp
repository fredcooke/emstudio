...
{
	m_dataFieldList.append(DataField("IAT","Intake Air Temperature",0,2,100,-20.0,60.0,-273.15));
	m_dataFieldList.append(DataField("CHT","Coolant/Head Temperature",2,2,100,-20.0,120.0,-273.15));
	...
	m_dataFieldList.append(DataField("MAT","Manifold Air Temperature",14,2,100.0,-20.0,120.0,-273.15));
